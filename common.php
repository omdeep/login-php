...
function outputBannerNavigation($pageName){
    ...
    echo '</li>';
    echo '<li class="nav-item">';
    echo '<a class="nav-link" href="game.php">Game</a>';
    echo '</li>';
    echo '<li class="nav-item">';
    ...
    $linkNames = array("Home", "Game", "About", "Leaderboard ","Log Out");
    $linkAddresses = array("home.php", "game.php", "about.php", "board.php", "logout.php");
